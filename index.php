...
.plan-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:28px}.plan-card{position:relative;background:#fffdf7;border-radius:22px;padding:36px 28px 28px;box-shadow:0 12px 40px #574a2830;overflow:hidden;display:flex;flex-direction:column;border:2px solid #e8dfcb;transition:transform .18s ease,box-shadow .18s ease}.plan-card:hover{transform:translateY(-4px);box-shadow:0 18px 48px #574a2840}.plan-card.silver{border-color:#9aa5b1}.plan-card.gold{border-color:var(--gold)}.plan-card::before{content:"";position:absolute;top:0;left:0;right:0;height:10px}.plan-card.silver::before{background:linear-gradient(90deg,#8a94a6,#5b6470)}.plan-card.gold::before{background:linear-gradient(90deg,var(--gold),#a9803a)}.plan-card-icon{width:64px;height:64px;border-radius:50%;display:grid;place-items:center;font-size:1.9rem;margin-bottom:16px;box-shadow:0 2px 8px #0002}.plan-card.silver .plan-card-icon{background:#d8dee4;border:2px solid #9aa5b1}.plan-card.gold .plan-card-icon{background:#f6e2a8;border:2px solid var(--gold)}.plan-card h3{font-size:1.55rem;margin:0 0 10px}.plan-card .perk{color:var(--muted);margin-bottom:22px;font-size:.95rem}.plan-ribbon{position:absolute;top:22px;right:-36px;background:var(--gold);color:var(--ink);font-weight:800;font-size:.74rem;letter-spacing:.03em;padding:7px 42px;transform:rotate(40deg);box-shadow:0 4px 12px #0003}.plan-method{margin-bottom:20px}.plan-method-label{font-size:.75rem;text-transform:uppercase;letter-spacing:.05em;color:var(--muted);font-weight:700;display:block;margin-bottom:6px}.plan-method select{width:100%;padding:12px 14px;border:1px solid #d9d1bf;border-radius:10px;background:#fff;font-size:.95rem}.plan-cta-group{display:flex;flex-direction:column;gap:10px;margin-top:auto}.plan-cta{display:flex;align-items:center;justify-content:space-between;width:100%;border:0;border-radius:999px;padding:16px 24px;font-weight:700;cursor:pointer;transition:transform .15s ease,box-shadow .15s ease;font-size:1rem}.plan-cta:hover{transform:translateY(-2px);box-shadow:0 10px 22px #0002}.plan-card.silver .plan-cta{background:var(--royal);color:#fff}.plan-card.gold .plan-cta{background:var(--gold);color:var(--ink)}.plan-cta .cta-label{opacity:.85;font-size:.78rem;font-weight:600;text-transform:uppercase;letter-spacing:.04em}.plan-cta .cta-price{font-family:Fraunces;font-size:1.15rem}@media(max-width:760px){.tier-grid{grid-template-columns:1fr}.amount-grid{grid-template-columns:repeat(2,1fr)}.form-row{grid-template-columns:1fr}.plan-grid{grid-template-columns:1fr}}
