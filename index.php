...
function make_webhook_url(): string { $local = is_file(__DIR__.'/local-config.php') ? (require __DIR__.'/local-config.php') : []; return trim((string)($local['MAKE_WEBHOOK_URL'] ?? getenv('MAKE_WEBHOOK_URL') ?: '')); }
